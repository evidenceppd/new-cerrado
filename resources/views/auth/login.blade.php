...
@section('title')
    Login sistema administrativo | {{ env('APP_NAME') }}
@endsection
            ...
            <div class="card-body px-3 py-4">
                <div class="mx-auto mb-4 text-center auth-logo">
                    <a href="index.html" class="logo-dark">
                        <img src="/assets_admin/images/logo.webp" height="60" style="width: 60%" class="img-fluid"
                            alt="logo dark">
                    </a>

                    <a href="index.html" class="logo-light">
                        <img src="/assets_admin/logo-white.png" height="100" style="width: 60%" class="img-fluid"
                            alt="logo light">
                    </a>
                </div>

                <p class="text-muted text-center mt-1 mb-4">Entre com seu e-mail e senha para acessar o painel.</p>
