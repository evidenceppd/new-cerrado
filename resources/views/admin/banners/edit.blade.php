...
@section('title')
    {{ isset($categorie) ? 'Editar banner' : 'Criar banner' }}
@endsection
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-0 fw-semibold">
                            {{ isset($categorie->id) ? 'Editar banner' : 'Adicionar banner' }}</h4>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Painel de Controle</a></li>
                            <li class="breadcrumb-item active"><a href="{{ route('blog.index') }}">banner</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Nome da banner</label>
                                            <div class="input-group">
                                                <span class="input-group-text" id="name"><i
                                                        class="ri-box-3-fill align-middle fs-18"></i></span>
                                                <input type="text" class="form-control" id="name"
                                                    aria-describedby="name" name="name" placeholder="Nome da banner"
                                        ...
                                        <div class="mb-3">
                                            <label for="description" class="form-label" data-bs-toggle="tooltip"
                                                ...
                                                data-bs-title="Descreva brevemente essa banner de seguro..">Descrição
                                                da
                                                banner<span><i class='bx bx-question-mark'></i></span>
                                            </label>
                                            <div class="input-group">
                                        ...
                                        {{-- <div class="mb-3">
                                            <label for="categorie_link" class="form-label" data-bs-toggle="tooltip"
                                                data-bs-placement="right" data-bs-title="Descreva a banner.">Link de
                                                redirecionamento da banner <span><i
                                        ...
                                        <div class="mb-3">
                                            <label for="categorie-type" class="form-label" data-bs-toggle="tooltip"
                                                data-bs-placement="right"
                                                data-bs-title="Diferencia em qual aba do site a banner será exibida, sendo 'seguros para você', ou 'seguros para a sua empresa'.">Tipo
                                                de
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckChecked"
                                                        ...
                                                        data-bs-title="Marque essa opção para exibir ou ocultar a banner no site">Mostrar
                                                        banner
